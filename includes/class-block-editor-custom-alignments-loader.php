...
class Block_Editor_Custom_Alignments_Loader {
	 ...
	 * @access   protected
	 *
	 * @var      array<Object>    $actions    The actions registered with WordPress to fire when the plugin loads.
	 */
	 ...
	 * @access   protected
	 *
	 * @var      array<Object>    $filters    The filters registered with WordPress to fire when the plugin loads.
	 */
