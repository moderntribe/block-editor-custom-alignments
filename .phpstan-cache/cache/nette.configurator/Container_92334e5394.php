...
class Container_92334e5394 extends _PHPStan_cd1adfd71\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService046(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_92334e5394 $container)
			{
	...
	public function createServiceContainer(): Container_92334e5394
	{
		return $this;
	}
