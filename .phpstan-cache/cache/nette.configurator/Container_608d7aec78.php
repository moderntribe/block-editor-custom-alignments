...
class Container_608d7aec78 extends _PHPStan_cd1adfd71\Nette\DI\Container
{
	protected $tags = [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			...
			'excludes_analyse' => [],
			'excludePaths' => [
				'analyseAndScan' => ['/Users/geoffdusome/Sites/qchi-lendnation/plugins/gutenberg-custom-alignments/vendor'],
				'analyse' => [],
			],
			'level' => 5,
			'paths' => [
	...
	public function createService046(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_608d7aec78 $container)
			{
	...
	public function createServiceContainer(): Container_608d7aec78
	{
		return $this;
	}
